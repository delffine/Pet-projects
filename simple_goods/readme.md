...
Бонус:
[Аналитическая панель на **DataLens**](https://datalens.yandex/z01wcggxq33el) с использованием **только SQL запросов** к базе PostgreSQL с преобработанным данынми по транзакциям. Примеры запросов в файле SQL.txt
